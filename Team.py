...
class Team(object):
    ...
    def get_players(self):
        ...
        logger.info('http://stats.nba.com/stats/commonteamroster?LeagueID=00&Season=2017-18&TeamID=' + str(self.teamID))
        headers = {
        ...
        try:
            r = requests.get('http://stats.nba.com/stats/commonteamroster?LeagueID=00&Season=2017-18&TeamID=' + str(self.teamID), headers=headers, timeout=3)
            r = r.json()
